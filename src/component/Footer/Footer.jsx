...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-slate-800 via-gray-700 to-slate-800 text-white border-t border-gray-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/all-posts" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  All Posts
                </Link>
              </li>
              <li>
                <Link to="/add-post" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  Write a Post
                </Link>
              </li>
              <li>
